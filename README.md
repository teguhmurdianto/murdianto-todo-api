# Murdianto Todo API using Clean Architecture
inspired on https://github.com/jasontaylordev/CleanArchitecture but specific .NET 6

# Reference
- https://github.com/jasontaylordev/CleanArchitecture/releases/tag/v6.1.0
